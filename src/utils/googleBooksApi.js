...
export async function searchBooks({ title, author, genre, startIndex = 0, maxResults = 20 }) {
    ...
    const query = parts.length ? parts.join('+') : encodeURIComponent(title || author || genre || '');
